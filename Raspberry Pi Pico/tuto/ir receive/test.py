#code pour recevoir un signal IR et le décoder avec micropython
#Bien lire les commentaire en fr pour que sa marche
#mettre le dossier complet ir_rx dans la racine du pico
...
# Definir les broche pour le récepteur pour le pico c'est gpio 16
if platform == "pyboard":
    p = Pin("X3", Pin.IN)
...
#choisir quel encodage on veut utiliser celui que j'utilise avec arduino est : test(1)
# **** DISPLAY GREETING **** 
