    ...
    while (1)
    {
        if (Serial1.available() > 0)
        {
            ...
            else
            {
                ...
                hour = (hour + 2) % 24;  // Ajouter 2 heures pour le fuseau horaire

                String time_str = (String)hour + ":" + (String)GPS.time.minute() + ":" + (String)GPS.time.second() + ":" + (String)GPS.time.centisecond();
